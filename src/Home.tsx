...
const Home = (props: HomeProps) => {
  ...
  const increment = () => {
    if (mintAmount >= 10) return setMintAmount(10);
    setMintAmount(mintAmount + 1);
  };
  const decrement = () => {
    if (mintAmount <= 1) return setMintAmount(1);
    setMintAmount(mintAmount - 1);
  };
  const maxMint = () => {
    setMintAmount(10);
      ...
      >
        <div className="mint__container">
          ...
          <div className="mint__counter__container row ">
            <div className="count ">
              <span onClick={(e) => decrement()} className="btn">
                -
              </span>
              <span>{mintAmount}</span>
              <span onClick={(e) => increment()} className="btn">
                +
              </span>
            </div>
            <div
                      ...
                      {isPresale &&
                        ...
                        candyMachine.state.goLiveDate.toNumber() >
                          ...
                          <Typography
                            ...
                            style={{ fontWeight: "bold" }}
                          >
                            <p className="until">UNTIL PUBLIC MINT</p>
                          </Typography>
                        )}
                    </>
                  )}
